...
#
# Mettre ici les derniers articles qui doivent apparaitre dans le
# menu principal
#
def derniers_articles
  [
    ["Mozart, Sonate K.545 - 3<sup>e</sup> mvt", 'blog/philicare/cfp/36'],
    ...
    ["Des exercices ou pas&nbsp;?", 'theme/ni_pour_ni_contre/exercices_ou_pas']
  ]
end
